...
from proto import text_pb2 as text__pb2
...
class TextProcessorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessText = channel.unary_unary(
                '/textprocessing.TextProcessor/ProcessText',
...
def add_TextProcessorServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'textprocessing.TextProcessor', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('textprocessing.TextProcessor', rpc_method_handlers)
